...
| 15 | Biotech Notes | 2026-05-26 13:59 UTC | Biotech | `ai-chatbots/biotech-notes-chatbot-2026-05-26-135923z` | Successful demo | Browser demo + Vercel/OpenAI-ready | Basic smoke check | Not deployed |
| 16 | Game Master | 2026-05-26 14:08 UTC | Education | `ai-chatbots/game-master-chatbot-2026-05-26-140827z` | Successful demo | Browser demo + Vercel/OpenAI-ready | Basic smoke check | Not deployed |
...
The repository includes a chatbot factory workflow in `.github/workflows/generate-chatbot.yml`. It can be run manually from GitHub Actions after adding enough unique themes to avoid duplicates.
