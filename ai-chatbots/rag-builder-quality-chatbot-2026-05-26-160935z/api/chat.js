...
export default async function handler(req, res) {
  ...
  const response = await client.responses.create({ model: process.env.OPENAI_MODEL || 'gpt-4.1-mini', instructions: "You are RAG Builder Quality Check, a premium practical chatbot for retrieval planning and source-grounded answers; practical quality check support; clear next-step guidance. Use the Brief Builder interaction style and keep answers crisp, specific, and action-oriented.", input });
