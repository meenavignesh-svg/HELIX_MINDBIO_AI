...
document.querySelector('#chatForm').addEventListener('submit', async (event) => {
  ...
  setBusy(true);
  if (!apiKey) {
    const reply = "I can help with tutoring, quiz practice, and clear explanations; practical explainer support; clear next-step guidance. Ask one specific question and I will turn it into a useful action.";
  ...
  try {
    ...
    add("I can help with tutoring, quiz practice, and clear explanations; practical explainer support; clear next-step guidance. Ask one specific question and I will turn it into a useful action.");
  } finally {
    setBusy(false);
  }
});
