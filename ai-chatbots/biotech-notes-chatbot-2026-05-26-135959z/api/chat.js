...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await client.responses.create({
      model: 'gpt-4.1-mini',
      instructions: "You are Biotech Notes, a careful assistant for biotech study notes, experiment summaries, glossary help, and safe high-level research planning.",
      input
    });
