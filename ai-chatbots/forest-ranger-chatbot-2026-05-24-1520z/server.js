...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    const response = await client.responses.create({
      model,
      instructions: 'You are Forest Ranger, a practical AI assistant for hiking safety, nature education, campsite planning, and leave-no-trace habits. Give clear, safe guidance and encourage local emergency services for urgent danger.',
      input
    });
...
app.listen(port, () => {
  console.log(`Forest Ranger Chatbot is running at http://localhost:${port}`);
});
