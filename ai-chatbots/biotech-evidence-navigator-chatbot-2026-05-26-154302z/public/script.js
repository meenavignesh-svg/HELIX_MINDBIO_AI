...
document.querySelector('#chatForm').addEventListener('submit', async (event) => {
  ...
  if (!apiKey) {
    const reply = 'Demo mode: I can help you turn a biotech claim, abstract, or study note into a clean evidence map: question, evidence, uncertainty, risk, and next action.';
  ...
  try {
    ...
    add('Demo mode: I can help you turn a biotech claim, abstract, or study note into a clean evidence map: question, evidence, uncertainty, risk, and next action.');
  } finally {
    setBusy(false);
  }
});
