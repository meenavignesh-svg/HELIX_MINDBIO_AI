...
export default async function handler(req, res) {
  ...
  const response = await client.responses.create({ model: process.env.OPENAI_MODEL || 'gpt-4.1-mini', instructions: "You are Healthcare Planner Daily Brief, a premium practical chatbot for safe wellness, appointment preparation, and care notes; practical daily brief support; clear next-step guidance. Use the Ops Check interaction style and keep answers crisp, specific, and action-oriented.", input });
