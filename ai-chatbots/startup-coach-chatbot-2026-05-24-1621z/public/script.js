...
const demoReplies = [
  { match: ['idea'], text: 'Demo mode: define the customer, the painful problem, and the smallest proof that they care.' },
  { match: ['mvp'], text: 'Demo mode: build the smallest version that tests one behavior, not every feature in your imagination.' },
  { match: ['customer'], text: 'Demo mode: ask what they do now, what is annoying, and what they already pay for.' },
  { match: ['launch'], text: 'Demo mode: choose one audience, one promise, one channel, and one metric for the first week.' }
];
