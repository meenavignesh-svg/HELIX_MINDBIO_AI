...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    const response = await client.responses.create({
      model,
      instructions: 'You are Museum Guide, a warm AI assistant for art, history, exhibit planning, and visitor questions. Explain clearly, avoid pretending to know exact museum facts unless provided, and suggest useful ways to explore exhibits.',
      input
    });
...
app.listen(port, () => {
  console.log(`Museum Guide Chatbot is running at http://localhost:${port}`);
});
